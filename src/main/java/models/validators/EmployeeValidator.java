...
public class EmployeeValidator {
    ...
    public static List<String> validate(
            EmployeeService service,EmployeeView ev, Boolean codeDuplicateCheckFlag, Boolean passwordChekFlag){
        ...
        //パスワードのチェック
        String passError = validatePassword(ev.getPassword(),passwordChekFlag);
        if (!passError.equals("")) {
